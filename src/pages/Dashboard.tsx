...
const communityProjects = [
  ...
  },
  {
    ...
    description: 'Track engagement, followers, and content performance across platforms.',
    author: 'David Kim',
    avatar: 'DK',
    likes: 156,
  ...
  },
  {
    ...
    description: 'Log workouts, track progress, and set personalized fitness goals.',
  ...
  },
  {
    ...
    description: 'Share recipes, create meal plans, and discover new cuisines.',
    author: 'Maria Garcia',
    avatar: 'MG',
    likes: 421,
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              See what others are building and get inspired. These projects were built and published by our community.
            </p>
          </div>
